...
export interface RuntimeObservability {
    createContext: (storeName: Types.StoreToken, args?: { traceId?: string; explain?: boolean }) => ObservabilityContext
    registerStore?: (args: { storeName: Types.StoreToken; debug?: DebugConfig; debugSink?: (e: DebugEvent) => void }) => void
}
...
export type RuntimeIo = Readonly<{
    ...
    query: <T extends Types.Entity>(handle: StoreHandle<T>, query: Types.Query, context?: ObservabilityContext, signal?: AbortSignal) => Promise<{ data: unknown[]; pageInfo?: any; explain?: any }>
}>
