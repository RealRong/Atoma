...
import { Protocol, type EntityId, type WriteAction, type WriteItem, type WriteItemMeta, type WriteOptions } from 'atoma-protocol'
import { entityId as entityIdUtils, immer as immerUtils, version, writeOptions as writeOptionsUtils } from 'atoma-shared'
