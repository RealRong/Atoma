...
If you want to inspect “client/store/sync/history runtime state” in dev, wire a devtools plugin (e.g. `atoma-devtools`) to your client. The core no longer ships a built-in devtools bridge.
