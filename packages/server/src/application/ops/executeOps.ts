...
import type { QueryOp, RemoteOpResult, WriteOp } from 'atoma-types/protocol'
import { composeEnvelopeOk, createErrorFromCode, withErrorTrace } from 'atoma-types/protocol-tools'
