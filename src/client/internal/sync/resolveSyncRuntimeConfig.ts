import { Sync, wantsPush, wantsSubscribe, type CursorStore, type OutboxReader, type SyncApplier, type SyncRuntimeConfig, type SyncTransport } from 'atoma-sync'
...
function resolveTransport(args: {
    ...
    if (!args.subscribeEnabled) {
        return { opsClient: backend.opsClient }
    }
