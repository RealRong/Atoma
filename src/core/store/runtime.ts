...
import type { IndexDefinition, IAdapter, JotaiStore, StoreConfig, StoreKey, StoreOperationOptions, Entity } from '../types'
...
export type StoreRuntime<T extends Entity> = {
    ...
    transform: (item: T) => T
    resolveOperationTraceId: (options?: StoreOperationOptions) => string | undefined
...
export function createOperationTraceIdResolver(context: StoreContext) {
    return (options?: StoreOperationOptions) => {
